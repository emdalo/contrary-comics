...
import { c as cn, l as formatMoney, p as useCart } from "./site-shell-BJKVPhYj.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/product-card-DTp9O4kE.js
var import_jsx_runtime = require_jsx_runtime();
function Badge({ className, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("inline-flex items-center rounded-sm bg-ink/5 px-2 py-0.5 text-xs font-medium tracking-wide text-ink", className),
		children
	});
}
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					className: "mt-1 font-display text-lg font-medium leading-snug text-ink",
					children: product.name
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "shrink-0 pt-5 text-sm tabular-nums text-ink",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: cn("size-4", wish && "fill-ink text-ink") })
		})]
	});
}
