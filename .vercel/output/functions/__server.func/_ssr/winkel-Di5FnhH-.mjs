...
import { a as SiteShell, c as cn, d as products, n as CATEGORIES } from "./site-shell-BvSAqMX6.mjs";
import { i as Route$2 } from "./router-BBF1BAyP.mjs";
import { t as ProductCard } from "./product-card-BGNlK6OL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/winkel-Di5FnhH-.js
...
function FilterChip({ active, onClick, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		type: "button",
		onClick,
		className: cn("h-11 rounded-sm px-4 text-sm font-bold transition-colors duration-150", active ? "bg-forest text-forest-fg" : "bg-surface text-teal"),
		children
	});
}
//#endregion
