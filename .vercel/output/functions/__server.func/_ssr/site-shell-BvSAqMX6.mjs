...
//#region node_modules/.nitro/vite/services/ssr/assets/site-shell-BvSAqMX6.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "size-5" }), wishes > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "absolute right-1.5 top-1.5 flex size-4 items-center justify-center rounded-full bg-forest text-[10px] font-bold text-forest-fg tabular-nums",
								children: wishes
							}) : null]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "size-5" }), count > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "absolute right-1.5 top-1.5 flex size-4 items-center justify-center rounded-full bg-teal text-[10px] font-bold text-teal-fg tabular-nums",
								children: count
							}) : null]
						})
					]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/winkel",
							className: "text-teal hover:text-forest",
							children: "Collectie"
						}) }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/winkel",
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap font-bold tracking-wide transition-[transform,box-shadow,background-color] duration-150 ease-out focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal disabled:pointer-events-none disabled:opacity-40 active:not-disabled:scale-95 [&_svg]:size-4 [&_svg]:shrink-0", {
	variants: {
		variant: {
			primary: "bg-forest text-forest-fg hover:bg-forest/90 hover:shadow-[0_0_24px_color-mix(in_oklab,var(--color-forest)_40%,transparent)]",
			secondary: "bg-teal text-teal-fg hover:bg-teal/90 hover:shadow-[0_0_24px_color-mix(in_oklab,var(--color-teal)_40%,transparent)]",
...
function CartDrawer() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			className: cn("absolute inset-0 bg-overlay/70 transition-opacity duration-200", open ? "opacity-100" : "opacity-0")
